...
INTEGER,SAVE :: nslots=5 !5                  ! number of time slots for 4D-LETKF
INTEGER,SAVE :: nbslot=5 !5 !1               !STEVE: nbslot=1 for testing for GMAO example case. Normal case is nbslot=5 ! basetime slot
