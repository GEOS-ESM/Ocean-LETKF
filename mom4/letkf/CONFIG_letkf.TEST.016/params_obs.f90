...
INTEGER,SAVE :: nslots=1 !5                  ! number of time slots for 4D-LETKF
INTEGER,SAVE :: nbslot=1 !5 !1               !STEVE: nbslot=1 for testing for GMAO example case. Normal case is nbslot=5 ! basetime slot
