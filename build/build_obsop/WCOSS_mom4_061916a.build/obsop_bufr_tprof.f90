...
!===============================================================================
  ...
  CALL read_bufr_dumpjb(lunit,id_t_obs,obs_data,nobs)
  ALLOCATE( elem(nobs) )
  ALLOCATE( rlon(nobs) )
  ALLOCATE( rlat(nobs) )
  ALLOCATE( rlev(nobs) )
  ...
  print *, "obsop_bufr_tprof.f90:: starting nobs = ", nobs
  do i=1,nobs
  ...
  DO n=1,nobs
    ...
    elseif (DO_INSITU_to_POTTEMP) then  
      STOP "obsop_bufr_tprof.f90::post-Trans_XtoY::  DO_INSITU_to_POTTEMP case must be coded."
    endif
  ...
  !-----------------------------------------------------------------------------
  WRITE(6,*) "In obsop_bufr_tprof.f90:: observations removed for:"
