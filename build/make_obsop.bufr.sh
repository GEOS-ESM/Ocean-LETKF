...
rm -f $BDIR/*.x
rm -f $BDIR/*.dat
sh $CDIR/lnkcommon_obsop_bufr.sh $model $CDIR/../
rm -f *.mod
rm -f *.o
...
$F90 $OMP $F90_OPT $F90_OBJECT_FLAG $NETCDF_INCLUDE read_bufr.f90
#--
...
BUF_LIB='-L/nwprod2/lib/bufr/v11.0.2 -lbufr_v11.0.2_4_64'
$F90 $OMP $F90_OPT obsop_bufr_tprof.f90 -o ${PGM}.tprof.x *.o $NETCDF_LIB $BUF_LIB
$F90 $OMP $F90_OPT obsop_bufr_sprof.f90 -o ${PGM}.sprof.x *.o $NETCDF_LIB $BUF_LIB
#$F90 $OMP $F90_OPT obsop_bufr_adt.f90   -o ${PGM}.adt.x   *.o $NETCDF_LIB $BUF_LIB
#$F90 $OMP $F90_OPT obsop_bufr_sst.f90   -o ${PGM}.sst.x   *.o $NETCDF_LIB $BUF_LIB
